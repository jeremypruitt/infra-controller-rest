...
// NewMachineIdentityManager - returns a new instance of the machine-identity manager
func NewMachineIdentityManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
